        ...
        jsonRequester.get('http://moviehunterproject.azurewebsites.net/api/Movies/' + id)
             .then(function (res) {
                ...
                $('.submit-new-rating').on('click', function(){
                    ...
                    jsonRequester.put('http://moviehunterproject.azurewebsites.net/movies/'+movieId+'/rating', { data: newMovieRatingModelStringified, contentType: 'application/json', headers: { Authorization: authorization } })
                        .then(function () {
