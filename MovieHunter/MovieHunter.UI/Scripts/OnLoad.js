$(document).ready(function () {
    ...
    $('#btn-login').on('click', function(){
        ...
        jsonRequester.post('http://moviehunterproject.azurewebsites.net/api/account/token', { data: loginData, contentType: 'application/x-www-form-urlencoded; charset=utf-8' })
            .then(function(data){
